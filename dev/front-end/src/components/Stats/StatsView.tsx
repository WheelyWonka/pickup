                  ...
                  <tr key={row.playerId} className="odd:bg-white even:bg-gray-50 hover:bg-orange-50/40 transition-colors">
                    ...
                    <td className="px-3 py-2">
                      <span className={`px-2 py-0.5 rounded-full text-xs font-semibold inline-flex items-center gap-1 ${
                        ...
                        row.fairnessIndicator==='bonus' ? 'bg-orange-100 text-orange-700' :
                        row.fairnessIndicator==='ref' ? 'bg-purple-100 text-purple-700' : 'bg-green-100 text-green-700'
                      }`}>
                        <span className={`w-2 h-2 rounded-full ${
                          row.fairnessIndicator==='underplayed' ? 'bg-blue-500' :
                          row.fairnessIndicator==='bonus' ? 'bg-orange-500' :
                          row.fairnessIndicator==='ref' ? 'bg-purple-500' : 'bg-green-500'
                        }`}></span>
